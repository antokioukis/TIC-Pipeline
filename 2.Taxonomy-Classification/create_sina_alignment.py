...
cmd = 'python3 4.Taxonomy-Classification/create_alignment_vector.py '
cmd += '-i ' + OUTPUT_FASTA_ALI_CLASS + ' -o 4.Taxonomy-Classification'
system(cmd)

cmd = 'Rscript 4.Taxonomy-Classification/ggplot_alignment_vector.R 4.Taxonomy-Classification ' + PDF_REGION_OUTPUT
system(cmd)
